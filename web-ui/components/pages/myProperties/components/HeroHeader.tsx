...
const StatCard: React.FC<StatCardProps> = ({
  ...
  >
    ...
    <div className="relative z-10">
      ...
      <div className="text-3xl font-extrabold tracking-tight mb-0.5">
        {value}
      </div>
  ...
  return (
    <div className="bg-linear-to-br from-blue-600 via-blue-700 to-indigo-700 relative overflow-hidden">
      <div
        ...
        style={{
          backgroundImage:
            "radial-gradient(circle at 20% 80%, white 0%, transparent 50%), radial-gradient(circle at 80% 10%, white 0%, transparent 40%)",
        }}
      />
        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-5">
          ...
          <button
            ...
            className="flex items-center gap-2 px-5 py-3 bg-white text-blue-700 font-bold text-sm
                                       ...
                                       transition-all duration-200 active:scale-95 self-start md:self-center cursor-pointer"
          >
